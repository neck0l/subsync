...
def options():
    return [
        ...
        { 'group': 'options', 'name': 'speechEngine', 'alias': '--engine', 'parser': parseEnum,
            'values': ['sphinx', 'vosk', 'whisper'] },
        { 'group': 'options', 'name': 'translateTo', 'alias': '--translate-to', 'metavar': 'LANG' },
        { 'group': 'options', 'name': 'translateEngine', 'alias': '--translate-engine', 'parser': parseEnum,
            'values': ['google', 'deepl'] },
        { 'group': 'options', 'name': 'subtitleStyle', 'alias': '--sub-style', 'metavar': 'PRESET' },
